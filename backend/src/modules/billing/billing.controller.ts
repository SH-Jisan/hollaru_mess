...
export class BillingController {
  ...
  @Roles(Role.MANAGER)
  @ApiOperation({
    summary: 'Start a new monthly billing session (Manager only)',
  })
  ...
  @ApiOperation({
    summary:
      'Get current month calculation, total costs, total meals, and meal rate',
  })
  @ApiResponse({
    status: 200,
    description: 'Month summary and meal rate returned.',
  })
  ...
  @Roles(Role.MANAGER)
  @ApiOperation({
    summary: 'Close and archive current monthly session (Manager only)',
  })
